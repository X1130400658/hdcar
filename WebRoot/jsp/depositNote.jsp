 ...
 <table class="table table-striped" id="list">
	 ...
	 <div class="box-footer clearfix">
              <ul class="pagination pagination-sm no-margin pull-right" id="getpage">
					<a href="jsp/depositCheck.jsp"><button class="btn btn-primary">返回</button></a>
              </ul>
      </div>
...
var statusr="";
       tmp="<tr><th>交易编号</th><th>转账金额</th><th>业务类型</th><th>状态标记</th><th>交易平台</th><th>交易单号</th><th>备注</th></tr>";
       for(var i=0;i<getJsonLength(datalist);i++)
       {
			...
			tmp+='<tr><td>'+datalist[i].transeq+'</td><td>'+datalist[i].amount+'</td>'+
			'<td>'+datalist[i].trantype+'</td><td>'+statusr+'</td><td>'+datalist[i].tranplat+'</td><td>'+datalist[i].tranno+'</td><td>'+datalist[i].note+'</td></tr>'
