  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">新增贷款产品</h4>
      </div>
      <div class="modal-body">
      <form id="formId2" method="post" action="loadprod/add">
  			<div class="form-group">
    			<label for="exampleInputEmail1">贷款产品名称</label>
    			<input type="text" name="prodname" class="form-control">
 			</div>
 			<div class="form-group">
    			<label for="exampleInputEmail1">首付比例%</label>
    			<input type="text" class="form-control" name="downpay">
 			</div>
 			<div class="form-group">
    			<label for="exampleInputEmail1">还款期数</label>
    			<input type="text" class="form-control" name="periodno">
 			</div>
 			<div class="form-group">
    			<label for="exampleInputEmail1">利息</label>
    			<input type="text" class="form-control" name="interest">
 			</div>
 			<div class="form-group">
    			<label for="exampleInputEmail1">还款方式</label>
...
window.onload=function(){
	...
	if(status=="1"){
	   ...
	   $.ajax({
				  type: 'get',
				  url: 'loadprod/getLoadprodList/'+pageNum+'/'+pageSize,
				  async: false,
				  data:  '',
				  success: function(data){
				  var pageCount=data.loadprodList.pageCount;
				   loadprodlist=data.loadprodList.objs;
				   genPageList(pageCount,pageSize)
				    xuanran(loadprodlist);
				  },
...
function xuanran(datalist){  
       tmp="<tr><th>贷款产品名称</th><th>首付比例%</th><th>还款期数</th><th>利息</th></tr>";
       for(var i=0;i<getJsonLength(datalist);i++)
       {
			tmp+='<tr><td>'+datalist[i].prodname+'</td><td>'+datalist[i].downpay+'</td><td>'+datalist[i].periodno+'</td><td>'+datalist[i].interest+'</td></tr>'
